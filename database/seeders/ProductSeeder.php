    ...
    public function run(): void
    {
        $products = [
            ...
            [
                ...
                'specs' => [
                    'Machine Type' => 'Automatic Ampoule Filling & Sealing',
                    'Output Speed' => '60–240 Ampoules/Minute',
                    'Filling Range' => '1 ml – 20 ml',
                    'Ampoule Sizes' => '1 ml, 2 ml, 5 ml, 10 ml, 20 ml',
                    'Number of Filling Heads' => '2 to 12 Heads',
                    'Filling Accuracy' => '±1%',
                    'Power Supply' => '415V AC, 50Hz, 3 Phase',
                    'Power Consumption' => '2–5 HP',
                    'Air Pressure' => '4–6 Bar',
                    'Machine Material' => 'SS304 / SS316',
                    'Sealing Type' => 'LPG & Oxygen Flame Sealing',
                ],
                'is_featured' => true,
                'sort_order' => 2,
            ],
            ...
            [
                ...
                'model_code' => null,
                'short_description' => 'Fully automatic, high-performance sticker labelling machine for precise self-adhesive label application on round glass, plastic, PET, HDPE, and metal bottles at 30–250 bottles per minute.',
                'long_description' => "The Automatic Round Bottle Sticker Labelling Machine is a fully automatic, high-performance labeling solution designed for precise application of self-adhesive labels on round containers. The machine ensures smooth operation, accurate label positioning, and high production efficiency, making it ideal for pharmaceutical, cosmetic, food, beverage, and chemical industries. Its robust stainless-steel construction and advanced control system provide reliable performance and long service life.\n\n**Benefits**\n- High production output\n- Precise label placement\n- Low maintenance\n- User-friendly operation\n- Compact design\n- GMP-compliant construction",
                'features' => [
                    'High-speed and accurate labeling',
                    'Suitable for glass, plastic, PET, HDPE, and metal round bottles',
                    'PLC-based control system with touchscreen HMI',
                    'Servo motor driven label dispensing',
                    'Automatic bottle separation and synchronization',
                    'No bottle, no label system',
                    'Easy label roll replacement',
                ...
                'specs' => [
                    'Machine Type' => 'Automatic Round Bottle Sticker Labelling',
                    'Labeling Speed' => '30–250 Bottles/Minute (depending on bottle & label size)',
                    'Bottle Diameter' => '25 mm – 100 mm',
                    'Bottle Height' => '50 mm – 300 mm',
                    'Label Height' => '10 mm – 150 mm',
                    'Label Length' => '20 mm – 300 mm',
                    'Label Roll Diameter' => 'Up to 400 mm',
                    'Core Diameter' => '75 mm',
                    'Accuracy' => '±1 mm',
                    'Power Supply' => '230V AC, 50Hz, Single Phase',
                    'Power Consumption' => '1–2 HP',
                    'Machine Material' => 'SS304 Stainless Steel',
                ],
                'sort_order' => 3,
                'meta_title' => 'Automatic Round Bottle Sticker Labelling Machine Manufacturer | Kailash Machine Tools',
                'meta_description' => 'Automatic round bottle sticker labelling machine with PLC HMI, servo label dispensing, 30–250 bottles/min output, and SS304 construction for pharma, cosmetic, food, and beverage lines.',
            ],
