...
var EnquiryForm_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`</div><div><label class="${ssrRenderClass([labelClass.value, "text-xs font-semibold uppercase tracking-widest"])}">Phone *</label><input${ssrRenderAttr("value", unref(form).phone)} type="tel" required inputmode="numeric" autocomplete="tel" maxlength="10" pattern="[0-9]{10}" class="${ssrRenderClass(inputClass.value)}" placeholder="10-digit phone number">`);
