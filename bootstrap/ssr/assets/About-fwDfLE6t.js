		...
		const timeline = [
			{
				...
				body: "Founded by the visionary Late Shri Chandubhai Mevada, establishing a benchmark in the pharmaceutical machinery industry built on integrity and technical mastery."
			},
			{
				year: "2002",
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(ssrRenderComponent(unref(Link), {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`pharmaceutical washing machines`);
								else return [createTextVNode("pharmaceutical washing machines")];
							}),
							_: 1
						}, _parent, _scopeId));
						_push(`, and `);
						...
						createVNode("p", { class: "rev mt-4 text-sm leading-7 text-slate-600" }, [
							createTextVNode(" Explore our core lines for "),
							createVNode(unref(Link), {
								href: "/products/injectable-liquid-filling",
								class: "font-semibold text-[color:var(--color-brand)] hover:text-[color:var(--color-brand-accent)]"
							}, {
								default: withCtx(() => [createTextVNode("vial and ampoule filling machines")]),
								_: 1
							}),
							createTextVNode(", "),
							createVNode(unref(Link), {
								...
								default: withCtx(() => [createTextVNode("pharmaceutical washing machines")]),
								_: 1
							}),
							createTextVNode(", and "),
							createVNode(unref(Link), {
								...
								default: withCtx(() => [createTextVNode("capping and sealing machines")]),
								_: 1
							}),
							createTextVNode(". ")
						]),
						createVNode("div", { class: "rev mt-10" }, [createVNode("h3", { class: "font-heading text-xl font-semibold text-slate-900" }, "What we stand for"), createVNode("ul", { class: "mt-4 space-y-4 text-sm leading-6 text-slate-700" }, [
							...
							createVNode("li", { class: "flex gap-3" }, [createVNode("span", { class: "mt-1 size-2 shrink-0 rounded-full bg-[color:var(--color-brand-accent)]" }), createVNode("div", null, [createVNode("strong", { class: "block text-slate-900" }, "cGMP by design"), createTextVNode("SS 316L, documented material traceability, FAT/SAT, IQ/OQ on every build.")])]),
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						ssrRenderList(timeline, (t, i) => {
							_push(`<li class="tline relative grid gap-4 pl-12 sm:grid-cols-2 sm:pl-0"${_scopeId}><div class="${ssrRenderClass(i % 2 === 0 ? "text-left sm:pr-10 sm:text-right" : "text-left sm:col-start-2 sm:pl-10")}"${_scopeId}><span class="font-heading text-sm font-semibold uppercase tracking-widest text-[color:var(--color-brand-accent)]"${_scopeId}>${ssrInterpolate(t.year)}</span><h3 class="mt-1 font-heading text-xl font-semibold text-slate-900"${_scopeId}>${ssrInterpolate(t.title)}</h3><p class="mt-2 text-sm leading-6 text-slate-600"${_scopeId}>${ssrInterpolate(t.body)}</p></div><div class="absolute left-5 top-2 size-4 -translate-x-1/2 rounded-full border-4 border-white bg-[color:var(--color-brand-accent)] shadow-lg sm:left-1/2"${_scopeId}></div></li>`);
						});
						_push(`<!--]--></ul>`);
					} else return [createVNode("ul", { class: "space-y-10" }, [(openBlock(), createBlock(Fragment, null, renderList(timeline, (t, i) => {
						return createVNode("li", {
							key: i,
							class: "tline relative grid gap-4 pl-12 sm:grid-cols-2 sm:pl-0"
						}, [createVNode("div", { class: i % 2 === 0 ? "text-left sm:pr-10 sm:text-right" : "text-left sm:col-start-2 sm:pl-10" }, [
						...
						], 2), createVNode("div", { class: "absolute left-5 top-2 size-4 -translate-x-1/2 rounded-full border-4 border-white bg-[color:var(--color-brand-accent)] shadow-lg sm:left-1/2" })]);
					}), 64))])];
				}),
				_: 1
			}, _parent));
